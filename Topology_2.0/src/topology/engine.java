...
//##############################################################################
  ...
  double force(int i) {
    ...
    for (int j=0; j<graph.numNodes(); j++) {
      if (i!=j) force+= forceA(i,j)+(graph.Kgaussian*random.nextGaussian()+1)*forceR(i,j);
    }
    return force;
  }
